...
class PaidScreen extends StatelessWidget {
  static const String routeName = '/paid';

  @override
  Widget build(BuildContext context) {
    final bloc = Provider.of<PaidBloc>(context);
  ...
  Widget _body(BuildContext context, PaidBloc bloc) {
    final dimension = MediaQuery.of(context).size;
  ...
  Widget _arisanWidget(BuildContext context, PaidBloc bloc) {
    return InkWell(
      onTap: bloc.addPaidClicked,
      child: Container(
